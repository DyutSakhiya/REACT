...
const Navbar = () => {
  ...
  /* ==================================================
     🔥 MOBILE-SAFE LOGO HANDLING (BASE64 ONLY)
  ================================================== */
  useEffect(() => {
    ...
    // CASE 1: logo stored as base64 STRING
    if (typeof user?.hotelLogo === "string") {
      logo = `data:image/png;base64,${user.hotelLogo}`;
    }

    // CASE 2: logo stored as OBJECT
    else if (
      user?.hotelLogo?.data &&
      user?.hotelLogo?.contentType
    ) {
