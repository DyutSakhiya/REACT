        ...
        <div className="md:w-2/3">
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-wrap gap-4">
              {["Actor 1", "Actor 2", "Actress 1", "Actress 2"].map(
                (actor, i) => (
          ...
          <div className="flex space-x-4">
            ...
            <button
              ...
              className="border border-gray-300 hover:bg-gray-100 text-gray-800 font-bold py-2 px-6 rounded-full transition duration-300"
            >
              Add to List
            </button>
          </div>
