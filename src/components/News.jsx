...
//       const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=78efee73f0144ade90c1e8b3581f3554&page=${page+1}&pageSize=${props.pageSize}`;
